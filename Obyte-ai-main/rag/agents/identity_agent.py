...
class IdentityAgent(BaseAgent):
    ...
    def get_user_clearance(self, username: str, provided_clearance: str = None) -> str:
        """
        Determines the clearance level of the user. Defaults to 'Public' if user is unrecognized.
        If provided_clearance is given, it overrides the mock mapping.
        """
        if provided_clearance in CLEARANCE_LEVELS:
            return provided_clearance
