...
class RAGOrchestrator:
    ...
    def process_query(self, username: str, query: str, top_k: int = 3, clearance: str = None) -> Dict[str, Any]:
        """
        ...
        user_clearance = self.identity_agent.get_user_clearance(username, clearance)
